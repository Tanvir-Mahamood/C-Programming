...
void mul(int k)
{
    ...
    printf("Enter row and collumn for Matrix A: ");
    scanf("%d %d",&r1,&c1);
    printf("Enter row and collumn for Matrix B: ");
    scanf("%d %d",&r2,&c2);
    while(c1 != r2)
    {
        printf("Error! Column of first matrix not equal to row of second matrix.Try again...");
        printf("\nEnter row and collumn for Matrix A: ");
        scanf("%d %d",&r1,&c1);
        printf("Enter row and collumn for Matrix B: ");
        scanf("%d %d",&r2,&c2);
    }
...
int main()
{
    ...
    int k;
    printf("enter the keynumber of matrix operation:\n\t1)Summation\n\t2)Subtraction\n\t3)Multiplication\n\t4)Transpose Matrix\n\t5)Identity\n");
    scanf("%d",&k);
    if(k==1 || k==2) sumsub(k);
    else if(k==3) mul(k);
    else if(k==4) trans(k);
